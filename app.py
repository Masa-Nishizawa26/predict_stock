...
st.write('※あくまでAIによる予測です（参考値）。こちらのアプリによる損害や損失は一切補填しかねます。')
...
st.markdown(link)
st.write('ティッカーシンボルついては上のリンク（SBI証券）をご参照ください')
...
st.write('Copyright © 2021 Tomoyuki Yoshikawa. All Reserved.')